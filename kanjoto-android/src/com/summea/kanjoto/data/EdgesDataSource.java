...
import com.summea.kanjoto.model.Edge;
...
public class EdgesDataSource {
    ...
    public Edge createEdge(Edge edge) {
        ...
        contentValues.put(KanjotoDatabaseHelper.COLUMN_GRAPH_ID, edge.getGraphId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_EMOTION_ID, edge.getEmotionId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_FROM_NODE_ID, edge.getFromNodeId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_TO_NODE_ID, edge.getToNodeId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_WEIGHT, edge.getWeight());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_POSITION, edge.getPosition());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_APPRENTICE_ID, edge.getApprenticeId());

        // create database handle
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        long insertId = db.insert(KanjotoDatabaseHelper.TABLE_EDGES, null,
                contentValues);

        Cursor cursor = db.query(
                KanjotoDatabaseHelper.TABLE_EDGES, allColumns,
    ...
    public void deleteEdge(Edge edge) {
        ...
        // delete edge
        db.delete(KanjotoDatabaseHelper.TABLE_EDGES,
    ...
    public List<Edge> getAllEdgesByApprentice(long apprenticeId) {
        ...
        String query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
    ...
    public List<Edge> getAllEdges(long apprenticeId, long graphId, long emotionId) {
        ...
        String query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                + " WHERE " + KanjotoDatabaseHelper.COLUMN_APPRENTICE_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_GRAPH_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?";
    ...
    public List<Edge> getAllEdges(long apprenticeId, long graphId, long emotionId,
        ...
        String query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                ...
                + " AND " + KanjotoDatabaseHelper.COLUMN_GRAPH_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_WEIGHT + "<?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_POSITION + "=?"
                + " ORDER BY " + KanjotoDatabaseHelper.COLUMN_WEIGHT + " ASC";
    ...
    public List<Edge> getAllEdges(long apprenticeId, long graphId, long emotionId, int fromNodeId,
        ...
        switch (mode) {
            case 0:
                query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                        + " WHERE " + KanjotoDatabaseHelper.COLUMN_APPRENTICE_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_GRAPH_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_POSITION + "=?";
            ...
            case 1:
                query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                        ...
                        + " AND " + KanjotoDatabaseHelper.COLUMN_GRAPH_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_FROM_NODE_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_POSITION + "=?";
                cursor = db.rawQuery(query, new String[] {
                        String.valueOf(apprenticeId),
                        String.valueOf(graphId),
            ...
            case 2:
                query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                        ...
                        + " AND " + KanjotoDatabaseHelper.COLUMN_GRAPH_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_TO_NODE_ID + "=?"
                        + " AND " + KanjotoDatabaseHelper.COLUMN_POSITION + "=?";
                cursor = db.rawQuery(query, new String[] {
                        String.valueOf(apprenticeId),
                        String.valueOf(graphId),
    ...
    public Edge getEdge(long graphId, long emotionId, int fromNodeId,
        ...
        String query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                + " WHERE " + KanjotoDatabaseHelper.COLUMN_GRAPH_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_FROM_NODE_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_TO_NODE_ID + "=?";
    ...
    public Edge updateEdge(Edge edge) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, edge.getId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_GRAPH_ID, edge.getGraphId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_EMOTION_ID, edge.getEmotionId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_FROM_NODE_ID, edge.getFromNodeId());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_TO_NODE_ID, edge.getToNodeId());
        ...
        db.update(KanjotoDatabaseHelper.TABLE_EDGES, contentValues, KanjotoDatabaseHelper.COLUMN_ID
                + "=" + edge.getId(), null);
    ...
    public List<Edge> getStrongPath(long apprenticeId, long graphId, long emotionId, int position,
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (fromNode > 0 && position > 0) {
                query += " AND " + KanjotoDatabaseHelper.COLUMN_FROM_NODE_ID + "=?";
                query += " AND " + KanjotoDatabaseHelper.COLUMN_POSITION + "=?";
    ...
    public Edge getStrongTransitionPath(long apprenticeId, long graphId, long emotionId,
        ...
        String query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_EDGES
                ...
                + " AND " + KanjotoDatabaseHelper.COLUMN_EMOTION_ID + "=?"
                + " AND " + KanjotoDatabaseHelper.COLUMN_FROM_NODE_ID + "=?"
                + " ORDER BY " + KanjotoDatabaseHelper.COLUMN_WEIGHT + " ASC LIMIT 1";
