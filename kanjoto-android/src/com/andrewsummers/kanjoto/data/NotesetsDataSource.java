...
public class NotesetsDataSource {
     ...
     */
    public NotesetsDataSource(Context context, String databaseName) {
    ...
    public Noteset createNoteset(Noteset noteset) {
        ...
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME,
                noteset.getName());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_EMOTION_ID,
                noteset.getEmotion());
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ENABLED,
                noteset.getEnabled());
        ...
        long insertId = db.insert(KanjotoDatabaseHelper.TABLE_NOTESETS, null,
                contentValues);

        Cursor cursor = db.query(
                KanjotoDatabaseHelper.TABLE_NOTESETS, allColumns,
    ...
    public void deleteNoteset(Noteset noteset) {
        ...
        // delete noteset
        db.delete(KanjotoDatabaseHelper.TABLE_NOTESETS,
                KanjotoDatabaseHelper.COLUMN_ID + " = " + noteset.getId(), null);

        // delete related notes
        db.delete(KanjotoDatabaseHelper.TABLE_NOTES,
                KanjotoDatabaseHelper.COLUMN_NOTESET_ID + " = " + noteset.getId(), null);
    ...
    public SparseArray<List<Note>> getAllNotesetBundles(long apprenticeId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String queryForRelatedNotes = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_NOTES
    ...
    public SparseArray<List<Note>> getAllNotesetBundlesByEmotion(long apprenticeId, long emotion_id) {
        ...
        String query = "SELECT * FROM " + KanjotoDatabaseHelper.TABLE_NOTESETS
                ...
                + " AND " + KanjotoDatabaseHelper.COLUMN_ENABLED + "=?";
    ...
    public Noteset updateNoteset(Noteset noteset) {
        ...
        db.update(KanjotoDatabaseHelper.TABLE_NOTESETS, contentValues,
                KanjotoDatabaseHelper.COLUMN_ID + "=" + noteset.getId(), null);
     ...
     * @return List of notesets.
     */
    public List<Noteset> getAllNotesetsByEmotion(long apprenticeId, long emotionId, int limit,
            int offset) {
        List<Noteset> notesets = new ArrayList<Noteset>();
