 ...
 */
public class KanjotoDatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    public KanjotoDatabaseHelper(Context context) {
        super(context, DATABASE_PATH + KanjotoDatabaseHelper.DATABASE_NAME, null, DATABASE_VERSION);
        mContext = context;
        Log.d("MYLOG", "database helper regular");
    }

    public KanjotoDatabaseHelper(Context context, String databaseName) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 1);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Early");
        contentValues.put(KanjotoDatabaseHelper.COLUMN_LEARNING_STYLE_ID, 1);
        db.insert(KanjotoDatabaseHelper.TABLE_APPRENTICES, null, contentValues);

        // add default emotions
        Log.d("MYLOG", "db: adding emotions...");
        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 1);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Happy");
        contentValues.put(KanjotoDatabaseHelper.COLUMN_LABEL_ID, 3);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_APPRENTICE_ID, 1);
        db.insert(KanjotoDatabaseHelper.TABLE_EMOTIONS, null, contentValues);

        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 2);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Sad");
        contentValues.put(KanjotoDatabaseHelper.COLUMN_LABEL_ID, 5);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_APPRENTICE_ID, 1);
        db.insert(KanjotoDatabaseHelper.TABLE_EMOTIONS, null, contentValues);
        ...
        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 1);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Emotion Graph");
        contentValues.put(KanjotoDatabaseHelper.COLUMN_LABEL_ID, 1);
        db.insert(KanjotoDatabaseHelper.TABLE_GRAPHS, null, contentValues);

        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 2);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Transition Graph");
        contentValues.put(KanjotoDatabaseHelper.COLUMN_LABEL_ID, 2);
        db.insert(KanjotoDatabaseHelper.TABLE_GRAPHS, null, contentValues);

        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 3);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Scale Graph");
        contentValues.put(KanjotoDatabaseHelper.COLUMN_LABEL_ID, 3);
        db.insert(KanjotoDatabaseHelper.TABLE_GRAPHS, null, contentValues);
        ...
        try {
            LABELS_CSV = am.open(KanjotoDatabaseHelper.LABELS_IMPORT_FILE);
        } catch (IOException e) {
        ...
        if (LABELS_CSV != null && br != null) {
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    contentValues = new ContentValues();
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, csvColumns[0]);
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, csvColumns[1]);
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_COLOR, csvColumns[2]);
        ...
        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 1);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Logic A");
        db.insert(KanjotoDatabaseHelper.TABLE_LEARNING_STYLES, null, contentValues);

        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 2);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Logic B");
        db.insert(KanjotoDatabaseHelper.TABLE_LEARNING_STYLES, null, contentValues);

        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 3);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Logic C");
        db.insert(KanjotoDatabaseHelper.TABLE_LEARNING_STYLES, null, contentValues);

        contentValues = new ContentValues();
        contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, 4);
        contentValues.put(KanjotoDatabaseHelper.COLUMN_NAME, "Logic D");
        db.insert(KanjotoDatabaseHelper.TABLE_LEARNING_STYLES, null, contentValues);

        // add default notevalues
        InputStream NOTEVALUES_CSV = null;
        try {
            NOTEVALUES_CSV = am.open(KanjotoDatabaseHelper.NOTEVALUES_IMPORT_FILE);
        } catch (IOException e) {
            Log.d("MYLOG", e.getMessage());
        }
        ...
        if (NOTEVALUES_CSV != null && br != null) {
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    contentValues = new ContentValues();
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, csvColumns[0]);
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_NOTEVALUE, csvColumns[1]);
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_NOTELABEL, csvColumns[2]);
                    contentValues.put(KanjotoDatabaseHelper.COLUMN_LABEL_ID, csvColumns[3]);
        ...
        for (int i = 0; i <= 108; i++) {
            contentValues = new ContentValues();
            contentValues.put(KanjotoDatabaseHelper.COLUMN_ID, i + 1);
            contentValues.put(KanjotoDatabaseHelper.COLUMN_NODE, i);
            db.insert(KanjotoDatabaseHelper.TABLE_VERTICES, null, contentValues);
        }
    }
