...
import com.andrewsummers.kanjoto.data.KeyNotesDataSource;
import com.andrewsummers.kanjoto.data.LabelsDataSource;
import com.andrewsummers.kanjoto.data.NotesetsDataSource;
import com.andrewsummers.kanjoto.data.NotevaluesDataSource;
...
import com.andrewsummers.kanjoto.model.KeyNote;
import com.andrewsummers.kanjoto.model.Label;
import com.andrewsummers.kanjoto.model.Note;
import com.andrewsummers.kanjoto.model.Notevalue;
import com.andrewsummers.kanjoto.view.PlaybackGLSurfaceView;
...
public class GenerateMusicActivity extends Activity {
    ...
    File musicSource = new File(externalDirectory + "kanjoto.mid");
    ...
    /*
     * private Runnable videoTask = new Runnable() { public void run() { playMusic(musicSource); }
     * };
     */
