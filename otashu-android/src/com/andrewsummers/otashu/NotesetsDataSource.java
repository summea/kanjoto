 ...
 * http://www.vogella.com/tutorials/AndroidSQLite/article.html Licensed under:
 * CC BY-NC-SA 3.0 DE:
 * http://creativecommons.org/licenses/by-nc-sa/3.0/de/deed.en Eclipse Public
...
public class NotesetsDataSource {
    ...
    private String[] allColumns = { NotesetCollectionOpenHelper.COLUMN_ID,
            NotesetCollectionOpenHelper.COLUMN_NOTEVALUES };
    ...
    public Noteset createNoteset(String notevalues) {
        ...
        contentValues.put(NotesetCollectionOpenHelper.COLUMN_NOTEVALUES,
                notevalues);

        long insertId = database
                .insert(NotesetCollectionOpenHelper.TABLE_NOTESETS, null,
                        contentValues);

        Cursor cursor = database.query(
                NotesetCollectionOpenHelper.TABLE_NOTESETS, allColumns,
                NotesetCollectionOpenHelper.COLUMN_ID + " = " + insertId, null,
                null, null, null);
    ...
    public void deleteNoteset(Noteset noteset) {
        ...
        database.delete(NotesetCollectionOpenHelper.TABLE_NOTESETS,
                NotesetCollectionOpenHelper.COLUMN_ID + " = " + id, null);
    }
    ...
    public List<Noteset> getAllNotesets() {
        ...
        Cursor cursor = database.query(
                NotesetCollectionOpenHelper.TABLE_NOTESETS, allColumns, null,
                null, null, null, null);
