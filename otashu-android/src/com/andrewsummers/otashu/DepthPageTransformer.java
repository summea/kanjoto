 ...
 * 
 * DepthPageTransformer structure based upon structure explained in
 * this tutorial:
 * http://developer.android.com/training/animation/screen-slide.html
 * 
 * Portions of this page/code are modifications based on work created
 * and shared by the Android Open Source Project and used according to
...
public class DepthPageTransformer implements ViewPager.PageTransformer {
	 ...
	 * @param position	Current position of page relative to current
